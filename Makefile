#############################################################################
# Makefile for building: ComSock
# Generated by qmake (3.1) (Qt 6.7.3)
# Project:  comsock.pro
# Template: app
# Command: /usr/lib64/qt6/bin/qmake -o Makefile comsock.pro
#############################################################################
...
INCPATH       = -I. -I/usr/include/qt6 -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtNetwork -I/usr/include/qt6/QtCore -I. -I/usr/lib64/qt6/mkspecs/linux-g++
QMAKE         = /usr/lib64/qt6/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /usr/lib64/qt6/bin/qmake -install qinstall
QINSTALL_PROGRAM = /usr/lib64/qt6/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ComSock1.0.0
DISTDIR = /home/syrno/euxvoa/.tmp/ComSock1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/lib64 -Wl,-rpath-link,/usr/lib64
LIBS          = $(SUBLIBS) /usr/lib64/libQt6Widgets.so /usr/lib64/libQt6Gui.so /usr/lib64/libGLX.so /usr/lib64/libOpenGL.so /usr/lib64/libQt6Network.so /usr/lib64/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		...
		comsock.pro irc.hpp main.cpp \
		irc.cpp
QMAKE_TARGET  = ComSock
DESTDIR       = 
TARGET        = ComSock
...
Makefile: comsock.pro /usr/lib64/qt6/mkspecs/linux-g++/qmake.conf /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt6/mkspecs/common/unix.conf \
		/usr/lib64/qt6/mkspecs/common/linux.conf \
		/usr/lib64/qt6/mkspecs/common/sanitize.conf \
		/usr/lib64/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents irc.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp irc.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_irc.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_irc.cpp
moc_irc.cpp: irc.hpp \
		moc_predefs.h \
		/usr/lib64/qt6/libexec/moc
	/usr/lib64/qt6/libexec/moc $(DEFINES) --include /home/syrno/euxvoa/moc_predefs.h -I/usr/lib64/qt6/mkspecs/linux-g++ -I/home/syrno/euxvoa -I/usr/include/qt6 -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtNetwork -I/usr/include/qt6/QtCore -I/usr/lib/gcc/x86_64-pc-linux-gnu/14/include/g++-v14 -I/usr/lib/gcc/x86_64-pc-linux-gnu/14/include/g++-v14/x86_64-pc-linux-gnu -I/usr/lib/gcc/x86_64-pc-linux-gnu/14/include/g++-v14/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/14/include -I/usr/include irc.hpp -o moc_irc.cpp
